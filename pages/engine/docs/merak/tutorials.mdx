---
title: CLI - Obelisk
description: Learn why we use Alkaid.
---
...
1. [Cocos v3.8.3 Dashboard](https://www.cocos.com/en/creator-download) First go to the official cocos creator website to download and install the dashboard
2. open your cocos Dashboard
3. create or import your project
4. open global config -> preference -> Engine Manager -> Using Custom -> Set Alkaid Code Path
5. Reopen the Dashboard and run the project
